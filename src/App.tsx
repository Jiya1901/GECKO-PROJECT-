        ...
        <section id="about" className="section-padding bg-white">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                { name: "Anshita Dhingra", id: "J016", image: "input_file_0.png" },
                { name: "Akriti Mehra", id: "J035", image: "input_file_1.png" },
                { name: "Jiya Chheda", id: "J013", image: "input_file_2.png" },
                { name: "Anindita Bhaduri", id: "J008", image: "input_file_3.png" }
              ].map((member, i) => (
